...
class BosAllPersonnelController extends Controller
{
    /**
     ...
     */
    public function index(Request $request, Bos $bos)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(Request $request, Bos $bos)
    {
        ...
        $personnel = $bos->allPersonnel()->create($validated);
